//
// OrderToken200ResponseOrderPaymentData.swift
//
...
/** Datos del pago */
public struct OrderToken200ResponseOrderPaymentData: Codable, JSONEncodable, Hashable {
    ...
    public var fromCard: OrderToken200ResponseOrderPaymentDataFromCard?
