  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('user-deuna'))
        obj.userDeuna = ApiClient.convertToType(data['user-deuna'], 'Boolean');
    }
    return obj;
  }
}
 ...
 */
InlineResponse2006.prototype.refreshToken = undefined;
...
/**
 * @member {Boolean} userDeuna
 */
InlineResponse2006.prototype.userDeuna = undefined;
