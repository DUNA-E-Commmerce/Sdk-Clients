...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsOrdersPostRequestOrder();
  });
  ...
  describe('MerchantsOrdersPostRequestOrder', function() {
    it('should create an instance of MerchantsOrdersPostRequestOrder', function() {
      // uncomment below and update the code to test MerchantsOrdersPostRequestOrder
      //var instance = new ApiGateway.MerchantsOrdersPostRequestOrder();
      //expect(instance).to.be.a(ApiGateway.MerchantsOrdersPostRequestOrder);
    });
