...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsTransactionsPurchasePostRequest();
  });
  ...
  describe('MerchantsTransactionsPurchasePostRequest', function() {
    it('should create an instance of MerchantsTransactionsPurchasePostRequest', function() {
      // uncomment below and update the code to test MerchantsTransactionsPurchasePostRequest
      //var instance = new ApiGateway.MerchantsTransactionsPurchasePostRequest();
      //expect(instance).to.be.a(ApiGateway.MerchantsTransactionsPurchasePostRequest);
    });
