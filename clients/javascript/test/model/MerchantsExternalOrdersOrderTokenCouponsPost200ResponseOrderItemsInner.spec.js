...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderItemsInner();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderItemsInner', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderItemsInner', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderItemsInner
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderItemsInner();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderItemsInner);
    });
