...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPostRequest();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenShippingMethodsPostRequest', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenShippingMethodsPostRequest', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenShippingMethodsPostRequest
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPostRequest();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPostRequest);
    });
