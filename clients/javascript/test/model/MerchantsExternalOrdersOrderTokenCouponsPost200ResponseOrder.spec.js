...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrder();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrder', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrder', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrder
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrder();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrder);
    });
