...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrderShippingAddress();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrderShippingAddress', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrderShippingAddress', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrderShippingAddress
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrderShippingAddress();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrderShippingAddress);
    });
