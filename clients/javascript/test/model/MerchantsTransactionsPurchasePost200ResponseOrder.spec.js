...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsTransactionsPurchasePost200ResponseOrder();
  });
  ...
  describe('MerchantsTransactionsPurchasePost200ResponseOrder', function() {
    it('should create an instance of MerchantsTransactionsPurchasePost200ResponseOrder', function() {
      // uncomment below and update the code to test MerchantsTransactionsPurchasePost200ResponseOrder
      //var instance = new ApiGateway.MerchantsTransactionsPurchasePost200ResponseOrder();
      //expect(instance).to.be.a(ApiGateway.MerchantsTransactionsPurchasePost200ResponseOrder);
    });
