...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsOrdersPostRequestOrderShippingAddress();
  });
  ...
  describe('MerchantsOrdersPostRequestOrderShippingAddress', function() {
    it('should create an instance of MerchantsOrdersPostRequestOrderShippingAddress', function() {
      // uncomment below and update the code to test MerchantsOrdersPostRequestOrderShippingAddress
      //var instance = new ApiGateway.MerchantsOrdersPostRequestOrderShippingAddress();
      //expect(instance).to.be.a(ApiGateway.MerchantsOrdersPostRequestOrderShippingAddress);
    });
