...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsTransactionsPurchasePost200ResponseOrderItemsInner();
  });
  ...
  describe('MerchantsTransactionsPurchasePost200ResponseOrderItemsInner', function() {
    it('should create an instance of MerchantsTransactionsPurchasePost200ResponseOrderItemsInner', function() {
      // uncomment below and update the code to test MerchantsTransactionsPurchasePost200ResponseOrderItemsInner
      //var instance = new ApiGateway.MerchantsTransactionsPurchasePost200ResponseOrderItemsInner();
      //expect(instance).to.be.a(ApiGateway.MerchantsTransactionsPurchasePost200ResponseOrderItemsInner);
    });
