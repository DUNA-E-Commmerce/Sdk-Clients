...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePostRequest();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenShippingRatePostRequest', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenShippingRatePostRequest', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenShippingRatePostRequest
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePostRequest();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePostRequest);
    });
