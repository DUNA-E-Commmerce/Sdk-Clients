...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrder();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrder', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrder', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrder
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrder();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsPost200ResponseOrder);
    });
