...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderShippingAddress();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderShippingAddress', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderShippingAddress', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderShippingAddress
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderShippingAddress();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderShippingAddress);
    });
