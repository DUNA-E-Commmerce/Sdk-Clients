...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderItemsInner();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderItemsInner', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderItemsInner', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderItemsInner
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderItemsInner();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrderItemsInner);
    });
