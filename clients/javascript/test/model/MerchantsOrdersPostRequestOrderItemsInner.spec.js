...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsOrdersPostRequestOrderItemsInner();
  });
  ...
  describe('MerchantsOrdersPostRequestOrderItemsInner', function() {
    it('should create an instance of MerchantsOrdersPostRequestOrderItemsInner', function() {
      // uncomment below and update the code to test MerchantsOrdersPostRequestOrderItemsInner
      //var instance = new ApiGateway.MerchantsOrdersPostRequestOrderItemsInner();
      //expect(instance).to.be.a(ApiGateway.MerchantsOrdersPostRequestOrderItemsInner);
    });
