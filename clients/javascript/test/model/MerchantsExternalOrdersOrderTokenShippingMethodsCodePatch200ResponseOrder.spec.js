...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsCodePatch200ResponseOrder();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenShippingMethodsCodePatch200ResponseOrder', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenShippingMethodsCodePatch200ResponseOrder', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenShippingMethodsCodePatch200ResponseOrder
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsCodePatch200ResponseOrder();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenShippingMethodsCodePatch200ResponseOrder);
    });
