...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrderShippingAddress();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrderShippingAddress', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrderShippingAddress', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrderShippingAddress
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrderShippingAddress();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrderShippingAddress);
    });
