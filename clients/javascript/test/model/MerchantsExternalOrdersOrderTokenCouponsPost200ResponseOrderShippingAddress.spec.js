...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderShippingAddress();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderShippingAddress', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderShippingAddress', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderShippingAddress
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderShippingAddress();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenCouponsPost200ResponseOrderShippingAddress);
    });
