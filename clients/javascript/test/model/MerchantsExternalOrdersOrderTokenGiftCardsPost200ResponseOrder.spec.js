...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrder();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrder', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrder', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrder
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrder();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenGiftCardsPost200ResponseOrder);
    });
