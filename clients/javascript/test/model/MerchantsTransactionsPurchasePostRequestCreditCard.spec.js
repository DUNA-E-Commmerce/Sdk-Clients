...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsTransactionsPurchasePostRequestCreditCard();
  });
  ...
  describe('MerchantsTransactionsPurchasePostRequestCreditCard', function() {
    it('should create an instance of MerchantsTransactionsPurchasePostRequestCreditCard', function() {
      // uncomment below and update the code to test MerchantsTransactionsPurchasePostRequestCreditCard
      //var instance = new ApiGateway.MerchantsTransactionsPurchasePostRequestCreditCard();
      //expect(instance).to.be.a(ApiGateway.MerchantsTransactionsPurchasePostRequestCreditCard);
    });
