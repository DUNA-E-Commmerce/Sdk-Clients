...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrder();
  });
  ...
  describe('MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrder', function() {
    it('should create an instance of MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrder', function() {
      // uncomment below and update the code to test MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrder
      //var instance = new ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrder();
      //expect(instance).to.be.a(ApiGateway.MerchantsExternalOrdersOrderTokenShippingRatePost200ResponseOrder);
    });
