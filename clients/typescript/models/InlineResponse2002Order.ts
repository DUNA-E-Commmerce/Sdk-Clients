...
export class InlineResponse2002Order {
    'currency'?: string;
    'discounts'?: Set<any>;
    ...
    'shippingOptions'?: InlineResponse2002OrderShippingOptions;
    'status'?: string;
    'storeCode'?: string;
    'subTotal'?: number;
    'taxAmount'?: number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "InlineResponse2002OrderShippingOptions",
            "format": ""
        },
        {
            "name": "status",
    ...
    static getAttributeTypeMap() {
        return InlineResponse2002Order.attributeTypeMap;
    }
