...
export class InlineResponse2003Order {
    'currency'?: string;
    'discounts'?: Set<any>;
    ...
    'orderId'?: string;
    'payment'?: any;
    'shippingAddress'?: InlineResponse2002OrderShippingAddress;
    'shippingAmount'?: number;
    'shippingOptions'?: InlineResponse2003OrderShippingOptions;
    'status'?: string;
    'storeCode'?: string;
    'subTotal'?: number;
    'taxAmount'?: number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "InlineResponse2002OrderShippingAddress",
            "format": ""
        },
        {
            "name": "shippingAmount",
        ...
        },
        {
            ...
            "type": "InlineResponse2003OrderShippingOptions",
            "format": ""
        },
        {
            "name": "status",
    ...
    static getAttributeTypeMap() {
        return InlineResponse2003Order.attributeTypeMap;
    }
